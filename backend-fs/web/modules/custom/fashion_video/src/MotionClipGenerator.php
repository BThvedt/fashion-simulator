...
final class MotionClipGenerator {
  ...
  private const DEFAULT_PROMPT = 'High-fashion runway show: the model struts forward taking a few confident catwalk steps toward the camera, stops and strikes a fierce dramatic pose, then turns. A dynamic cinematic camera sweeps and pans with a slow push-in following the movement. On both sides of the runway, dense crowds of paparazzi photographers erupt in a relentless frenzy — an overwhelming, near-constant storm of huge, brilliant, blinding white camera flashes firing from every direction, giant strobing bursts and blown-out pops that flare and bloom across the entire frame, whiting out the background in pulses and dramatically lighting the model with hard, rapidly flickering highlights and sharp moving shadows. The camera flashes are the dominant light source and the star of the scene. Keep any glittery sparkles or firework-like bursts very subtle and occasional — just a faint tasteful shimmer catching the light, never overpowering the flashes. Editorial high-fashion lighting, glamorous dramatic atmosphere, fabric and hair moving naturally. No text, no captions, no watermark.';
